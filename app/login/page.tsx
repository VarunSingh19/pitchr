                ...
                <div className="p-6 lg:p-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-mono text-muted-foreground leading-relaxed">
                      Pitchr uses OAuth2 credentials to link Gmail dispatch loops. Click below to continue.
                    </p>
                  </div>
                  ...
                  <motion.button
                    ...
                    className="group/btn w-full flex items-center bg-foreground text-background text-xs font-mono tracking-widest uppercase select-none disabled:opacity-50"
                  >
                    <span className="bg-[#ea580c] text-white w-12 h-12 flex items-center justify-center border-r border-background/20 shrink-0">
                      {isRedirecting ? (
                    ...
                    <span className="flex-1 text-center py-3.5 font-bold tracking-widest">
                      {isRedirecting ? "REDIRECTING TO IDENTITY PROVIDER..." : "CONTINUE WITH GOOGLE"}
                    </span>
                  </motion.button>
